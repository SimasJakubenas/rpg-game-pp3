...
def game_rules():
    ...
    print('       ¦           ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~              ¦')
    print('       ¦     ► Navigate the menu by pressing corresponding number       ¦')
    print('       ¦          or letter and confirm it with "enter" key             ¦')
    print('       ¦    ► Navigate the map by chosing any of the 4 directions.      ¦')
    print('       ¦      Once you have reach the edge of map you will not be       ¦')
    print('       ¦              advance further in that direction                 ¦')
    print('       ¦     ► Talk to the Vendor he will be abe to help you to         ¦')
    print('       ¦                  advance to the new area                       ¦')
